    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Registra y controla todos los gastos operativos</p>
        </div>
      </div>
      ...
      <div className="table-wrap">
        <table>
          <thead>
            <tr><th>#</th><th>Fecha</th><th>Categoría</th><th>Descripción</th><th>Método Pago</th><th>Gasto Total</th><th>Impuesto %</th><th>Valor Imp.</th><th>Total Neto</th><th>Notas</th>{!isReadOnly && <th>Acciones</th>}</tr>
          </thead>
          <tbody>
            {gastos.length === 0 ? (
